...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="laundry/images/favicon.png">
     <?php
             include('connect.php');
    ...
    <link href="laundry/laundry/css/lib/chartist/chartist.min.css" rel="stylesheet">
  <link href="laundry/css/lib/owl.carousel.min.css" rel="stylesheet" />
    ...
    <link href="laundry/css/style.css" rel="stylesheet">
